...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
      ...
      this._router = this.router.events.pipe(filter((event): event is NavigationEnd => event instanceof NavigationEnd)).subscribe((event: NavigationEnd) => {
